...
export const Questions: any = [
    ...
    },
    {
        ...
        "description": "Identify the part that guarantees basic rights to Indian citizens.",
        "answer": [
            {
                "text": "Part III",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the total number of schedules in the Indian Constitution.",
        "answer": [
            {
                "text": "12",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the Article that ensures equality among all citizens.",
        "answer": [
            {
                "text": "Article 15",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the amendment that significantly altered the Indian Constitution.",
        "answer": [
            {
                "text": "42nd Amendment",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the authority responsible for the protection of the Indian Constitution.",
        "answer": [
            {
    ...
    },
    {
        ...
        "description": "Identify the part that outlines the principles for governance.",
        "answer": [
            {
                "text": "Part IV",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the year when the Indian Constitution was officially adopted.",
        "answer": [
            {
                "text": "1949",
                "isCorrect": true
    ...
    },
    {
        ...
        "description": "Identify the Article that allows citizens to move to the Supreme Court for enforcement of Fundamental Rights.",
        "answer": [
            {
    ...
    {
        "id": uuidv4(),
        "question": "Which part of the Indian Constitution is called the 'Magna Carta'?",
        "description": "Identify the part of the Constitution that is compared to the Magna Carta.",
        "answer": [
            {
    ...
    {
        "id": uuidv4(),
        "question": "Which Article of the Indian Constitution provides for the formation of a Finance Commission?",
    ...
    },
    {
        ...
        "description": "Identify the Article that makes education a fundamental right.",
        "answer": [
            {
                "text": "Article 21A",
                "isCorrect": true
    ...
    {
        "id": uuidv4(),
        "question": "Which part of the Indian Constitution is related to the Union and its territory?",
