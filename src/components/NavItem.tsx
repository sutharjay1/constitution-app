    ...
    <div className={cn("flex gap-4", { "flex-col": row })}>
      ...
      {isOpen ? (
        ...
        >
          ...
          <div className="w-full flex lg:block   flex-col lg:flex-row  relative bg-zinc-50 dark:bg-transparent dark:backdrop-blur-2xl dark:borde-y-[1px] border-zinc-900 dark:border-zinc-100 shadow-xl shadow-zinc-900/5 dark:shadow-black/5 ">
