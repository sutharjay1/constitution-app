...
const GameButton = ({
  ...
  const variants = {
    default:
      "border-mediumBlue perspective-800 rotate-x-30 bg-mediumBlue flex w-full transform cursor-pointer items-center gap-5 rounded-2xl border-2 border-b-[4.5px] p-4 text-sm font-medium shadow-[0_8px_0_#3B82F6A6] transition-all duration-200 hover:translate-y-[3px] hover:shadow-[0_5px_0_#3B82F6A6] active:translate-y-[8px] active:shadow-none",
    white:
    ...
    blue: "flex w-full translate-y-[2px] cursor-pointer items-center gap-5 rounded-2xl border-2 border-b-2 p-4 px-6 text-sm font-medium transition-all duration-200 ease-in-out active:translate-y-[6px] active:shadow-none border-[#2d5fad] bg-mediumBlue text-zinc-900 shadow-[0_4px_0_#3B82F680]",
    transparent:
      "flex w-full translate-y-[2px] cursor-pointer items-center gap-5 rounded-2xl border-2 border-b-2 p-4 px-6 text-sm font-medium transition-all duration-200 ease-in-out active:translate-y-[6px] active:shadow-none border-zinc-600 bg-transparent text-zinc-300 shadow-[0_4px_0_#52525b]",
    disableBtn:
