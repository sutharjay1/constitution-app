        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 md:grid-cols-2">
            <div className="mt-2 flex flex-col space-y-6">
              <div className="rounded-xl border-2 border-b-4 border-mediumBlue/70 bg-mediumBlue/80 p-2 sm:p-4">
                <div className="flex flex-col gap-1">
                  <div className="flex items-center justify-start gap-2">
                    <HiMiniArrowLongLeft
                      className={cn(
                        "h-6 w-6 cursor-pointer text-zinc-200 transition-all hover:-translate-x-1",
                        DINRoundProBlack.className,
                      )}
                    />
                    <p
                      className={cn(
                        "text-base font-medium text-zinc-300 sm:text-lg",
                  ...
                  <p
                    className={cn(
                      "text-balance text-lg text-zinc-100 sm:text-xl md:text-2xl",
                      DINRoundProBlack.className,
                    )}
                  >
                ...
                <div className="perspective-3d w-full active:-translate-y-0">
                  <div className="flex w-full flex-col items-center justify-center -space-y-4 border-t-[1.8px] border-zinc-500 bg-background py-12">
                    ...
                    <div className="z-0 mx-auto flex w-full max-w-7xl items-center justify-center perspective-800">
                      <div className="flex w-fit items-center justify-center gap-3 rounded-full border-4 border-zinc-500/50 p-3 rotate-x-45">
                        <GameButton
                    ...
                    <div className="z-0 mx-auto flex w-full max-w-7xl items-center justify-center perspective-800">
                      <div className="mr-20 mt-7 flex w-fit items-center justify-center gap-3 rounded-full p-3 rotate-x-45">
                        <GameButton
                          className="w-fit rounded-full"
                          onClick={() => handleGameButton()}
                          disable
